...
void intersection(struct vecteur*a, struct vecteur*b,
		  struct vecteur*o, struct vecteur*n,
		  struct vecteur*x);
...
/* The straight line [AB] is cut by
   the plane defined with the origin o and the normal vector n.

   The resulting point is stored in x.
*/
void intersection(struct vecteur*a, struct vecteur*b,
		  struct vecteur*o, struct vecteur*n,
		  struct vecteur*x){
	printf("vecteur: intersection: TODO\n");
